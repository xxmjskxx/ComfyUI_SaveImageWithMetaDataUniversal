...
CAPTURE_FIELD_LIST = {
    ...
    "ACEModelLoader": {
        MetaField.MODEL_HASH: {'field_name': "dcae_checkpoint", 'format': KNOWN["calc_model_hash"]},
        MetaField.MODEL_NAME: {'field_name': "dcae_checkpoint"},
    },
    "ACEPlusLoader": {
    ...
    "BLIP Model Loader": {
        MetaField.MODEL_HASH: {'field_name': "blip_model", 'format': KNOWN["calc_unet_hash"]},
        MetaField.MODEL_NAME: {'field_name': "blip_model"},
    },
    ...
    "CLIP Positive-Negative w/Text (WLSH)": {
        MetaField.NEGATIVE_PROMPT: {'field_name': "negative", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "positive", 'validate': KNOWN["is_positive_prompt"]},
    },
    "CLIPLoader": {
    ...
    "CLIPTextEncodeFlux": {
        ...
        MetaField.NEGATIVE_PROMPT: {'field_name': "t5xxl", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "t5xxl", 'validate': KNOWN["is_positive_prompt"]},
    },
    ...
    "CLIPTextEncodeLumina2": {
        MetaField.NEGATIVE_PROMPT: {'field_name': "system_prompt", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "system_prompt", 'validate': KNOWN["is_positive_prompt"]},
    },
    ...
    "CLIPTextEncodeSDXL": {
        MetaField.NEGATIVE_PROMPT: {'field_name': "text_l", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "text_g", 'validate': KNOWN["is_positive_prompt"]},
    },
    "CLIPTextEncodeSDXL+": {
        MetaField.NEGATIVE_PROMPT: {'field_name': "text", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "text", 'validate': KNOWN["is_positive_prompt"]},
    ...
    "CR Encode Scheduled Prompts": {
        MetaField.NEGATIVE_PROMPT: {'field_name': "next_prompt", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "next_prompt", 'validate': KNOWN["is_positive_prompt"]},
    },
    "CR LoRA List": {
    ...
    "CR Load Scheduled Models": {
        MetaField.MODEL_HASH: {'field_name': "model_list", 'format': KNOWN["calc_unet_hash"]},
        MetaField.MODEL_NAME: {'field_name': "model_list"},
    },
    ...
    "CreateCFGScheduleFloatList": {
        MetaField.CFG: {'field_name': "cfg_scale_end"},
    },
    "CreateHookLora": {
        MetaField.LORA_MODEL_HASH: {'field_name': "lora_name", 'format': KNOWN["calc_lora_hash"]},
        MetaField.LORA_MODEL_NAME: {'field_name': "lora_name"},
    ...
    "DualCFGGuider": {
        MetaField.CFG: {'field_name': "cfg_cond2_negative"},
    },
    "DualCLIPLoader": {
    ...
    "FBGSampler": {
        ...
        MetaField.GUIDANCE: {'field_name': "guidance_max_change"},
    ...
    "FL_HFHubModelUploader": {
        MetaField.MODEL_HASH: {'field_name': "model_repo_path", 'format': KNOWN["calc_unet_hash"]},
        MetaField.MODEL_NAME: {'field_name': "model_repo_path"},
    },
    ...
    "FL_KsamplerSettings": {
        ...
        MetaField.SAMPLER_NAME: {'field_name': "sampler"},
        MetaField.SCHEDULER: {'field_name': "scheduler"},
        MetaField.STEPS: {'field_name': "Pass_1_steps"},
    },
    "FL_UnloadModel": {
        MetaField.MODEL_HASH: {'field_name': "model", 'format': KNOWN["calc_unet_hash"]},
        MetaField.MODEL_NAME: {'field_name': "model"},
    ...
    "ImpactWildcardEncode": {
        MetaField.NEGATIVE_PROMPT: {'field_name': "wildcard_text", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "wildcard_text", 'validate': KNOWN["is_positive_prompt"]},
    },
    ...
    "KSampler Cycle": {
        MetaField.CFG: {'field_name': "cfg"},
        MetaField.DENOISE: {'field_name': "denoise_cutoff"},
        MetaField.SAMPLER_NAME: {'field_name': "sampler_name"},
        MetaField.SCHEDULER: {'field_name': "scheduler"},
        MetaField.SEED: {'field_name': "seed"},
        MetaField.STEPS: {'field_name': "steps"},
    ...
    "LoadTextEncoderShared //Inspire": {
        MetaField.MODEL_HASH: {'field_name': "model_name2", 'format': KNOWN["calc_unet_hash"]},
        MetaField.MODEL_NAME: {'field_name': "model_name2"},
    },
    "LoadVQVAE": {
        MetaField.MODEL_HASH: {'field_name': "model_name", 'format': KNOWN["calc_unet_hash"]},
        MetaField.MODEL_NAME: {'field_name': "model_name"},
    ...
    "RegionalSampler": {
        MetaField.DENOISE: {'field_name': "denoise"},
        MetaField.SAMPLER_NAME: {'field_name': "additional_sampler"},
        MetaField.SEED: {'field_name': "seed"},
        MetaField.STEPS: {'field_name': "steps"},
    },
    ...
    "SDXL Power Prompt - Positive (rgthree)": {
        MetaField.NEGATIVE_PROMPT: {'field_name': "prompt_g", 'validate': KNOWN["is_negative_prompt"]},
        MetaField.POSITIVE_PROMPT: {'field_name': "prompt_g", 'validate': KNOWN["is_positive_prompt"]},
    },
